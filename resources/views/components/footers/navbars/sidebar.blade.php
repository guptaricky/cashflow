<aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'add-cash-flow-details2' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('add-cash-flow-details2') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'settings' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('settings') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
