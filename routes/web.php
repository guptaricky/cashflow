...
use App\Http\Livewire\CompanyMaster;
use App\Http\Livewire\CurrencyMaster;
...
Route::get('company', CompanyMaster::class)->name('company');
Route::get('currency', CurrencyMaster::class)->name('currency');
